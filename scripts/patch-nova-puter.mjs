...
html = html.replaceAll('GitHub Pages يشغّل الواجهة والأدوات المحلية فقط؛ أضف رابط خادم API لتفعيل المحادثة وتوليد AI.','المحادثة تعمل مباشرة عبر Claude Sonnet 5 من المتصفح. رابط API الخارجي اختياري فقط.');
