(() => {
  ...
  window.EgyptStory={install(scene,home){
    ...
    const beats=[
      {who:'المنبّه',line:'قوم يا بطل… دي تالت «خمس دقايق»!',from:[-154,1.07,-155.6],to:[-154,1.60,-155.4],look:[-154,.98,-154.6]},
      {who:'أنا',line:'حاضر… بس المخ لسه بيفتح. محدّش يدوس عليه.',from:[-154,1.60,-155.4],to:[-152,1.72,-151],look:[-145,1.5,-145]},
