(() => {
  ...
  window.EgyptStory={install(scene,home){
    ...
    const beats=[
      {who:'الصبح بدري',line:'المنبّه بيرن… وأنا عامل نفسي مش من سكان الشقة.',action:'نايم على السرير والمنبّه جنبي.',from:[-155.05,3.0,-151.4],look:[-155.05,1.0,-154.75]},
    ...
    const status=window.__V12_PROLOGUE={ready:true,played:false,running:false,startsAtHome:true,version:'11.24',beat:0,typed:0,starts:0};
