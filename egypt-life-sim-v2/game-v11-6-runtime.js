(() => {
  ...
  const stableMenu=()=>{
    ...
    if(foot&&foot.textContent!==`V${document.documentElement.dataset.release||'11.22.0'} — مشوار الفطار — شنطة وحفظ وحوار العيلة`)foot.textContent=`V${document.documentElement.dataset.release||'11.22.0'} — مشوار الفطار — شنطة وحفظ وحوار العيلة`;
