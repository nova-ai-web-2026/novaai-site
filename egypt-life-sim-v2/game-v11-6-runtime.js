(() => {
  ...
  const stableMenu=()=>{
    ...
    if(foot&&foot.textContent!==`V${document.documentElement.dataset.release||'11.19.0'} — مشوار الفطار — شنطة وحفظ وحوار العيلة`)foot.textContent=`V${document.documentElement.dataset.release||'11.19.0'} — مشوار الفطار — شنطة وحفظ وحوار العيلة`;
