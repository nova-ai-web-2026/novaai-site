(() => {
  ...
  function loadV11AudioFix(){
    ...
    const s=document.createElement('script');s.src='game-v11-audiofix.js?v=11.9&visual=11.11&sfx=11.21.0';s.dataset.egyptV11Audiofix='true';s.async=false;s.onload=markReady;s.onerror=()=>fail('V11 audio fix failed to load');document.body.appendChild(s);
  }
  function loadV111(){
  ...
  function loadV11(){
    ...
    const s=document.createElement('script');s.src='game-v11.js?v=11&release=11.21.0';s.dataset.egyptV11='true';s.async=false;s.onload=loadV111;s.onerror=()=>fail('V11 script failed to load');document.body.appendChild(s);
  }
  function loadV10(){
