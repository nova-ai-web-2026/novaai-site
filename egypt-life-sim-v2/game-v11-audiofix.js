(() => {
  ...
  function loadV1112Actual(){
    ...
    const s=document.createElement('script');s.src='game-v11-10-actual-sfx.js?v=11.12';s.dataset.egyptV1110Sfx='true';s.async=false;s.onerror=()=>console.error('V11.12 mobile-hardened SFX failed to load');document.body.appendChild(s);
  }
  ...
  window.__V11_AUDIOFIX={version:15,release:'11.12',visualRelease:'11.11',singleAudioEngine:true,startupGuard:false,legacyExtraLayersDisabled:true,v1110ActualSfx:true,v1112SfxHardening:true,actualSamples:true,remoteSamplePrimary:true,sameOriginFallback:true,localWavFallback:true,proceduralFallback:true,v1111EgyptDetails:true,additiveVisualLayer:true};
