(() => {
  ...
  function loadV118Sfx(){
    ...
    s.src='game-v11-8-sfx.js?v=11.8.1';
    s.dataset.egyptV118Sfx='true';
    s.async=false;
    s.onerror=()=>console.error('V11.8.1 event SFX failed to load');
  ...
  function loadV118Fallback(){
    ...
    const s=document.createElement('script');
    s.src='game-v11-6-runtime.js?v=11.8.1';
    s.dataset.egyptV116Runtime='true';
    s.async=false;
    s.onload=loadV118Sfx;
    s.onerror=()=>{console.error('V11.8.1 runtime failed to load');loadV118Sfx();};
    document.body.appendChild(s);
  }
