(() => {
  ...
  function loadV112(){
    ...
    const s=document.createElement('script');s.src='game-v11-2-audio.js?v=11.3';s.dataset.egyptV112Audio='true';s.async=false;s.onerror=()=>console.error('V11.3 calm audio failed to load');document.body.appendChild(s);
  }
  async function boot(){
    installStartupGuard();
    ...
    window.__V11_AUDIOFIX={version:4,legacyLocked:true,v11BusDisconnected:true,legacyCoreMuted:true,startupGuard:true,intervalMs:80};
