(() => {
  ...
  const sources=['./vendor/babylon.js?v=v3-motion-home-2','https://cdn.babylonjs.com/babylon.js','https://cdn.jsdelivr.net/npm/babylonjs/babylon.js','https://unpkg.com/babylonjs/babylon.js'];
  const launchGame=engineSource=>{if(window.__SHWARE3_MODULE_LOADING)return;window.__SHWARE3_MODULE_LOADING=true;window.__SHWARE3_ENGINE_SOURCE=engineSource;if(status)status.textContent='جاري تجهيز شوارع النور V3.1…';const module=document.createElement('script');module.type='module';module.src='./src/game.js?v=v3-motion-home-2';module.onerror=()=>showFatal('ملفات اللعبة اتحملت ناقصة. اعمل إعادة تحميل للصفحة.');document.body.appendChild(module);};
